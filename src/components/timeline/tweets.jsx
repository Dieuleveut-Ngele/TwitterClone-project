...
import newyorkprofil from "./images/imageNewyork.png"
...
function Tweets() {
  return (
    <div className='tweets'>
      ...
      <Tweet tweetProfile={cnnprofile} title="CNN" value="@CNN .7m " 
      ...
      <Tweet tweetProfile={newyorkprofil} title="The New York Times" image={tweetimage} value="@nytimes . 2h " 
      ...
      <Tweet tweetProfile={tweetoiseau} title="Twitter" value="@Twitter . oct 29" 
